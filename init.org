  ...
  (defun user-custom-keywords ()
    ...
    (let ((user-custom-keywords
            '((":problem:" . 'material-deep-orange-500)
               ...
               (":active:" . 'material-pink-500)
               (":idle:" . 'material-cyan-500)
               (":stopped:" . 'material-blue-grey-500)
               (":desc:" . 'material-lime-500)
               (":cost:" . 'material-lime-500)
               (":ex:" . 'material-teal-500)
               (":refine:" . 'material-indigo-900)
               (":prop:" . 'material-light-green-500)
               (":why:" . 'material-light-blue-500)
               (":who:" . 'material-light-blue-500)
               (":what:" . 'material-light-blue-500)
               (":how:" . 'material-light-blue-500)
               (":when:" . 'material-light-blue-500)
               (":id:" . 'material-light-blue-500)
               (":task:" . 'material-light-blue-500)
               (":parallel:" . 'material-cyan-A400)
               (":src:" . 'material-amber-500)
               (":input:" . 'material-blue-900)
               (":output:" . 'material-brown-500))))
