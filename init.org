...
#+begin_src elisp
  (defface material-red-900
    '((t . (:background "#b71c1c" :foreground "#ffffff")))
    "Material design red 900"
    :group 'material)

  (defface material-pink-900
    '((t . (:background "#880E4F" :foreground "#ffffff")))
    "Material design pink 900"
    :group 'material)

  (defface material-purple-900
    '((t . (:background "#4A148C" :foreground "#ffffff")))
    "Material design purple 900"
    :group 'material)

  (defface material-deep-purple-900
    '((t . (:background "#311B92" :foreground "#ffffff")))
    "Material design deep-purple 900"
    :group 'material)

  (defface material-indigo-900
    '((t . (:background "#1A237E" :foreground "#ffffff")))
    "Material design indigo 900"
    :group 'material)

  (defface material-blue-900
    '((t . (:background "#0D47A1" :foreground "#ffffff")))
    "Material design blue 900"
    :group 'material)

  (defface material-light-blue-900
    '((t . (:background "#01579B" :foreground "#ffffff")))
    "Material design light-blue 900"
    :group 'material)

  (defface material-cyan-900
    '((t . (:background "#006064" :foreground "#ffffff")))
    "Material design cyan 900"
    :group 'material)

  (defface material-teal-900
    '((t . (:background "#004D40" :foreground "#ffffff")))
    "Material design teal 900"
    :group 'material)

  (defface material-green-900
    '((t . (:background "#1B5E20" :foreground "#ffffff")))
    "Material design green 900"
    :group 'material)

  (defface material-light-green-900
    '((t . (:background "#33691E" :foreground "#ffffff")))
    "Material design light green 900"
    :group 'material)


  (defface material-lime-900
    '((t . (:background "#827717" :foreground "#ffffff")))
    "Material design lime 900"
    :group 'material)

  (defface material-yellow-900
    '((t . (:background "#F57F17" :foreground "#ffffff")))
    "Material design yellow 900"
    :group 'material)

  (defface material-amber-900
    '((t . (:background "#FF6F00" :foreground "#ffffff")))
    "Material design amber 900"
    :group 'material)

  (defface material-orange-900
    '((t . (:background "#E65100" :foreground "#ffffff")))
    "Material design orange 900"
    :group 'material)

  (defface material-deep-orange-900
    '((t . (:background "#BF360C" :foreground "#ffffff")))
    "Material design deep orange 900"
    :group 'material)


  (defface material-brown-900
    '((t . (:background "#3E2723" :foreground "#ffffff")))
    "Material design brown 900"
    :group 'material)

  (defface material-grey-900
    '((t . (:background "#212121" :foreground "#ffffff")))
    "Material design grey 900"
    :group 'material)

  (defface material-blue-grey-900
    '((t . (:background "#263238" :foreground "#ffffff")))
    "Material design blue-grey 900"
    :group 'material)




  (defface material-red-500
    '((t . (:background "#f44336" :foreground "#ffffff")))
    "Material design red 500"
    :group 'material)

  (defface material-pink-500
    '((t . (:background "#E91E63" :foreground "#ffffff")))
    "Material design pink 500"
    :group 'material)

  (defface material-purple-500
    '((t . (:background "#9C27B0" :foreground "#ffffff")))
    "Material design purple 500"
    :group 'material)

  (defface material-deep-purple-500
    '((t . (:background "#673AB7" :foreground "#ffffff")))
    "Material design deep-purple 500"
    :group 'material)

  (defface material-indigo-500
    '((t . (:background "#3F51B5" :foreground "#ffffff")))
    "Material design indigo 500"
    :group 'material)

  (defface material-blue-500
    '((t . (:background "#2196F3" :foreground "#ffffff")))
    "Material design blue 500"
    :group 'material)

  (defface material-light-blue-500
    '((t . (:background "#03A9F4" :foreground "#ffffff")))
    "Material design light-blue 500"
    :group 'material)

  (defface material-cyan-500
    '((t . (:background "#00BCD4" :foreground "#ffffff")))
    "Material design cyan 500"
    :group 'material)

  (defface material-cyan-A400
    '((t . (:background "#00E5FF" :foreground "#ffffff")))
    "Material design cyan A400"
    :group 'material)

  (defface material-teal-500
    '((t . (:background "#009688" :foreground "#ffffff")))
    "Material design teal 500"
    :group 'material)

  (defface material-green-500
    '((t . (:background "#4CAF50" :foreground "#ffffff")))
    "Material design green 500"
    :group 'material)

  (defface material-light-green-500
    '((t . (:background "#8BC34A" :foreground "#ffffff")))
    "Material design light green 500"
    :group 'material)


  (defface material-lime-500
    '((t . (:background "#CDDC39" :foreground "#ffffff")))
    "Material design lime 500"
    :group 'material)

  (defface material-yellow-500
    '((t . (:background "#FFEB3B" :foreground "#ffffff")))
    "Material design yellow 500"
    :group 'material)

  (defface material-amber-500
    '((t . (:background "#FFC107" :foreground "#ffffff")))
    "Material design amber 500"
    :group 'material)

  (defface material-orange-500
    '((t . (:background "#FF9800" :foreground "#ffffff")))
    "Material design orange 500"
    :group 'material)

  (defface material-deep-orange-500
    '((t . (:background "#FF5722" :foreground "#ffffff")))
    "Material design deep orange 500"
    :group 'material)


  (defface material-brown-500
    '((t . (:background "#795548" :foreground "#ffffff")))
    "Material design brown 500"
    :group 'material)

  (defface material-grey-500
    '((t . (:background "#9E9E9E" :foreground "#ffffff")))
    "Material design grey 500"
    :group 'material)

  (defface material-blue-grey-500
    '((t . (:background "#607D8B" :foreground "#ffffff")))
    "Material design blue-grey 500"
    :group 'material)
#+end_src
...
#+begin_src elisp :noweb yes
    ...
    (defun user-custom-keywords ()
      ...
      (let ((user-custom-keywords
              '((":problem:" . 'material-blue-500)
                 (":solution:" . 'material-green-500)

                 (":next:" . 'material-blue-500)
                 (":success:" . 'material-green-500)
                 (":wait:" . 'material-orange-500)
                 (":unscheduled:" . 'material-purple-500)
                 (":failed:" . 'material-red-500)

                 (":intro:" . 'material-deep-purple-500)
                 (":type:" . 'material-deep-purple-500)
                 (":build:" . 'material-deep-purple-500)
                 (":prop:" . 'material-deep-purple-500)
                 (":desc:" . 'material-deep-purple-500)
                 (":ex:" . 'material-deep-purple-500)
                 (":why:" . 'material-deep-purple-500)
                 (":who:" . 'material-deep-purple-500)
                 (":what:" . 'material-deep-purple-500)
                 (":how:" . 'material-deep-purple-500)
                 (":when:" . 'material-deep-purple-500)
                 (":id:" . 'material-deep-purple-500)
                 (":task:" . 'material-deep-purple-500)
                 (":use:" . 'material-deep-purple-500)
                 (":context:" . 'material-deep-purple-500)

                 (":active:" . 'material-blue-500)
                 (":idle:" . 'material-orange-500)
                 (":stopped:" . 'material-blue-grey-500)
                 (":parallel:" . 'material-cyan-A400)

                 (":input:" . 'material-blue-500)
                 (":apply:" . 'material-green-500)
                 (":output:" . 'material-purple-500)

                 (":refine:" . 'material-cyan-A400)

                 (":cost:" . 'material-lime-500)
                 (":src:" . 'material-amber-500)
                 )))
    ...
    (add-hook 'org-mode-hook #'user-custom-keywords)
